...
class AddAgriculturalDialog extends StatefulWidget {
  final ValueNotifier<int> refreshPropertiesNotifier;

  AddAgriculturalDialog({required this.refreshPropertiesNotifier});

  @override
  _AddAgriculturalDialogState createState() => _AddAgriculturalDialogState();
}

class _AddAgriculturalDialogState extends State<AddAgriculturalDialog> {
