...
import '../../../server/agricultural/get/get_agricultural_by_id.dart';
import 'edit_agricultural_form.dart';

class AgriculturalDetailDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder(
      ...
      builder: (BuildContext context, int value, Widget? child) {
        return Dialog(
          child: FutureBuilder<AgriculturalPropertyApi>(
            future: fetchAgriculturalById(propertyId),
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                AgriculturalPropertyApi property = snapshot.data!;
                  ...
                  child: Column(
                    ...
                    children: [
                                                ...
                                                TextButton(
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    String videoId = property
                                                        ...
                                                        .toString();
                                                    bool isDeleted =
                                                        await deleteAgriculturalVideoById(
                                                            propertyId,
                                                            videoId);
                                                    if (isDeleted) {
                                                      final snackBar = SnackBar(
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                            'Acres: ${property.acres}${AgriculturalDetailDialog.acresSuffix}'),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                            'Price: ${property.price}${AgriculturalDetailDialog.priceSuffix}'),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Buildings: ${property.buildings}'),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Crops: ${property.crops}'),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Water Sources: ${property.waterSources}'),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Soil Type: ${property.soilType}'),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Equipments: ${property.equipment}'),
                      ),
                    ],
                  ),
                );
