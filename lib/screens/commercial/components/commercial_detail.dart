...
import 'package:admin/server/commercial/delete/delete_commercial_image_by_id.dart';
import 'package:admin/server/commercial/delete/delete_commercial_video_by_id.dart';
...
import 'edit_commercial_form.dart';

class CommercialDetailDialog extends StatelessWidget {
  ...
  CommercialDetailDialog({required this.propertyId, required this.refreshPropertiesNotifier});
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      ...
      builder: (BuildContext context, int value, Widget? child) {
       return Dialog(
          child: FutureBuilder<CommercialPropertyApi>(
            future: fetchCommercialById(propertyId),
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                CommercialPropertyApi property = snapshot.data!;
                ...
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                                          ...
                                          actions: <Widget>[
                                            ...
                                            TextButton(
                                              ...
                                              onPressed: () async {
                                                ...
                                                bool isDeleted = await deleteCommercialImageById(propertyId, imageId);
                                                Navigator.of(context).pop();
                                                if (isDeleted) {
                                                ...
                                                actions: <Widget>[
                                                  ...
                                                  TextButton(
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      bool isDeleted = await deleteCommercialVideoById(propertyId, videoId);
                                                      if (isDeleted) {
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Acres: ${property.acres}${CommercialDetailDialog.acresSuffix}'),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Price: ${property.price}${CommercialDetailDialog.priceSuffix}'),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Traffic Count: ${property.trafficCount}'),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
