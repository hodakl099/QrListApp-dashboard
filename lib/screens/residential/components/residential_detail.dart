...
import 'package:admin/server/residential/delete/delete_residential_image_by_id.dart';
import 'package:admin/server/residential/delete/delete_residential_video_by_id.dart';
import 'package:admin/server/residential/get/get_office_by_id.dart';
...
import 'edit_residential_form.dart';

class ResidentialDetailDialog extends StatelessWidget {
  ...
  ResidentialDetailDialog({required this.propertyId, required this.refreshPropertiesNotifier});
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      ...
      builder: (BuildContext context, int value, Widget? child) {
       return Dialog(
          child: FutureBuilder<ResidentialPropertyApi>(
            future: fetchResidentialById(propertyId),
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ResidentialPropertyApi property = snapshot.data!;
                ...
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                                          ...
                                          actions: <Widget>[
                                            ...
                                            TextButton(
                                              ...
                                              onPressed: () async {
                                                ...
                                                bool isDeleted = await deleteResidentialImageById(propertyId, imageId);
                                                Navigator.of(context).pop();
                                                if (isDeleted) {
                                                ...
                                                actions: <Widget>[
                                                  ...
                                                  TextButton(
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      bool isDeleted = await deleteResidentialVideoById(propertyId, videoId);
                                                      if (isDeleted) {
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Acres: ${property.acres}${ResidentialDetailDialog.acresSuffix}'),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Price: ${property.price}${ResidentialDetailDialog.priceSuffix}'),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Bedrooms: ${property.bedrooms}'),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Bedrooms: ${property.bathrooms}'),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('parking: ${property.parking}'),
                      ),
