...
import 'add_residential_diaog.dart';
import 'residential_card.dart';
import 'residential_detail.dart';
...
class _ResidentialPropertiesState extends State<ResidentialProperties> {
  ...
  Future<List<ResidentialPropertyApi>>? _propertiesFuture;
      ...
      children: [
                ...
                showDialog(
                    ...
                    builder: (context) {
                      if (menuAppController.userPermissions.contains('Add'))
                        return AddResidentialDialog(
                            refreshPropertiesNotifier:
                                _refreshPropertiesNotifier);
                      else
                        return AlertDialog(
        ...
        ValueListenableBuilder(
          ...
          builder: (context, value, child) {
            return FutureBuilder<List<ResidentialPropertyApi>>(
              future: fetchAllResidential(),
                ...
                if (snapshot.hasData) {
                  return Responsive(
                    mobile: FileInfoCardGridView(
                      ...
                      refreshPropertiesNotifier: _refreshPropertiesNotifier,
                    ),
...
class FileInfoCardGridView extends StatelessWidget {
  final List<ResidentialPropertyApi> properties;
      ...
      itemBuilder: (context, index) => GestureDetector(
          onTap: () {
            ...
            if (propertyId != null) {
              showDialog(
                context: context,
                builder: (context) => ResidentialDetailDialog(
