...
import '../../../server/sub_categories/get/get_subcategory_by_id.dart';
      ...
      builder: (BuildContext context, int value, Widget? child) {
        return Dialog(
          child: FutureBuilder<CategoryApi>(
            future: fetchSubCategoryById(propertyId),
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                bool isDeleted = await deleteSubCategoryById(propertyId);
                if (isDeleted) {
