...
import 'package:admin/server/touristic/delete/delete_touristic_by_id.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import '../../../constants.dart';
import '../../../controllers/MenuAppController.dart';
import '../../../server/agricultural/delete/delete_agricultural_by_id.dart';
import '../../../server/residential/delete/delete_residential_by_id.dart';

class TouristicCard extends StatelessWidget {
                      ...
                      return AlertDialog(
                        ...
                        actions: <Widget>[
                          ...
                          TextButton(
                            ...
                            onPressed: () async {
                              Navigator.of(context).pop();
                              bool isDeleted = await deleteTouristicById(property.id!);
                              if (isDeleted) {
...
Widget buildNetworkImage({
  required TouristicPropertyApi property,
