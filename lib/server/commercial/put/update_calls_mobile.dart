...
Future<http.StreamedResponse> updateCommercialPropertyMobile(String id, CommercialPropertyApi property) async {
  var uri = Uri.parse("http://localhost:8080/properties/commercial/updateProperty/$id");
