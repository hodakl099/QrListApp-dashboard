...
Future<http.StreamedResponse> uploadTouristicPropertyMobile(TouristicPropertyApi property) async {
  var uri = Uri.parse("http://localhost:8080/properties/touristic/Add");
